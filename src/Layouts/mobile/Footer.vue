...
<template>
  <v-bottom-navigation v-model="active" app height="auto" class="footer bg-surface app-footer" density="comfortable">
    <template v-for="item in NavigationItems" :key="item.routeName">
      <v-btn class="channel-wrapper py-2" variant="text" style="min-width: 0; padding: 0" :value="item.routeName"
