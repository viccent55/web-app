  ...
  <v-dialog v-model="noteDialogVisible" max-width="1200"  height="100%" @after-enter="onOpenNoteDialog"
    ...
    <v-card :loading="loading" class="main-contain">
      ...
      <v-card-text class="pa-0 pb-4">
        <v-row no-gutters>
          <!-- Left: Video area -->
          <v-col cols="12" md="7" lg="8" class="d-flex justify-center" :class="smAndDown ? '' : 'border-e-thin'">
            <v-card flat class="py-3">
              ...
              <v-card-text :style="getStyle">
                <ContentArticle :content="state.data?.content" ref="content-article" />
              </v-card-text>
            </v-card>
          </v-col>
          ...
          <v-col cols="12" md="5" lg="4" class="d-flex flex-column">
            <div class="d-flex justify-end mt-2 py-0 pr-4" v-if="!smAndDown">
